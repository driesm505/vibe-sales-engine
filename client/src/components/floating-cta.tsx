          ...
          <Card className="bg-white shadow-2xl border-2 border-conversion-orange rounded-2xl w-80">
            <CardContent className="p-6">
              <div className="flex justify-between items-start mb-4">
                <div>
                  <h3 className="font-bold text-lg text-gray-900">Ready to Start?</h3>
                  <p className="text-gray-600 text-sm">Get your MVP in 7 days</p>
                </div>
                <button
      ...
      <div className="fixed bottom-0 left-0 right-0 z-30 lg:hidden bg-white border-t border-gray-200 p-4 shadow-lg">
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="text-xs text-gray-600">From €2,500 • 7-day delivery</div>
          </div>
          <Button
            onClick={scrollToContact}
